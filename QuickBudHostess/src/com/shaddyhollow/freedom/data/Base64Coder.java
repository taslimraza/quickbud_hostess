...
public class Base64Coder {
	...
	public static void encodeFile(File inputFile, File outputFile)
			throws IOException {
	...
	public static String encodeArray(byte[] in) throws IOException {
		StringBuffer out = new StringBuffer();
		out.append(Base64Coder.encode(in, 0, in.length));
		return out.toString();
	}

	public static byte[] decodeArray(String in) throws IOException {
		byte[] buf = Base64Coder.decodeLines(in);
		return buf;
	}

	public static void decodeFile(File inputFile, File outputFile)
			throws IOException {
